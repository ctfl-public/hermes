"""Legacy-compatible serial HERMES orchestration.

This module preserves the current ``voxel2stl`` calling contract while moving
the implementation into the package framework.
"""
...
def voxel2stl_legacy(
    ...
    *,
    ...
    """Run the legacy serial voxel-to-STL workflow from framework code."""
...
def process_single_volume_legacy(args):
    """Worker function for legacy random-volume processing."""
    ...
    get_stl_legacy(surf, filevoxel, temp_number, volume_length, corner, surface_settings, saving_options)
