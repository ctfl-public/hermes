...
`test_mpi_framework_processes_corner_samples_with_workflow_backend`
- Input: `small_primary_0.tif`
- Checks: the package MPI sample runner uses the shared workflow backend for two explicit corner samples.
